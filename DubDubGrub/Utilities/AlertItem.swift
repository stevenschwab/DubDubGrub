...
struct AlertContext {
    ...
    static let didFailWithErrorOnLocationManager = AlertItem(title: Text("Server Error"),
                                                message: Text("Unable to retrieve your location. Please check your internet connection and try again."),
                                                dismissButton: .default(Text("Ok")))
    
    //MARK: - LocationListView Errors
    
    static let unableToGetAllCheckedInProfiles = AlertItem(title: Text("Server Error"),
                                                message: Text("We are unable to get users checked into locations at this time.\n Please try again."),
                                                dismissButton: .default(Text("Ok")))
    ...
    static let createProfileSucess = AlertItem(title: Text("Profile Created Successfully"),
